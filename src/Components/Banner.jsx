 ...
 <div className="w-full  fixed top-0 left-0   z-[999] h-14 py-3 bg-black text-white justify-center inline-flex">
  <div className=" gap-[231px] inline-flex">
    ...
    <div class=" flex-col justify-center gap-10 mt-[-0.3rem]  ">
      ...
      <button type="button" onClick={()=>{setToggle(!toggle)}}  class="bg-gray-100 flex justify-center pt-2 h-10 w-36 text-sm text-gray-900 dark:text-white rounded-lg   cursor-pointer  hover:bg-gray-300 dark:hover:bg-gray-700 dark:hover:text-white">
