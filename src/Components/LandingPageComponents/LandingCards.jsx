...
const dispatch=useDispatch()
    ...
    return (
        <div onClick={()=>{nav(props.link);dispatch(setModule(props.link)) }} className=' cursor-pointer relative flex gap-5   py-4 px-4  h-80 w-1/2 border border-black rounded-2xl shadow-md overflow-hidden'>
