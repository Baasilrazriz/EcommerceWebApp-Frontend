...
import { fetchUserByUsername, setUSerByUser } from '../../../Features/Dashboard/usersInfoSlice';

function DashboardUpdateUser(props) {
...
<h1 className="text-left text-4xl font-bold   text-gray-700 px-6 ">Update User Info</h1>
<form action="" className=' mx-5 flex flex-col gap-5' method="post" onClick={handleSubmit}>
...
<div class="relative h-11    w-80 shadow-lg">
                    ...
                    <button
                        ...
                        className="relative top-3 left-10  bg-blue-500 hover:bg-blue-800 text-white text-2xl font-bold h-10 w-[12rem]   rounded-full shadow-lg shadow-neutral-950 hover:text-white transform transition-all duration-500 ease-in-out hover:scale-110 hover:brightness-110 hover:animate-pulse active:animate-bounce"
                      >
                       search User
                      </button>    
          </div>
...
<div className='flex gap-5 mx-32'>
<div class="relative h-11 w-full shadow-lg">
                      <input
                      type="text"
                        placeholder=""
