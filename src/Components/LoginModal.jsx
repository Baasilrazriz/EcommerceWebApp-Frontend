...
import { closeSignupModal, openSignupModal } from "../Features/Mart/signupSlice";
                    ...
                    <div className="flex flex-col gap-4 mx-12">
                      ...
                      <div>
                        <p class="mt-1 flex justify-center font-sans text-sm font-light leading-normal text-inherit antialiased">
                          ...
                          <NavLink
                            class=" ml-1 font-sans  font-bold leading-normal text-purple-900 antialiased transition-all duration-400 ease-in hover:text-purple-700  focus:text-purple-800 hover:underline focus:underline hover:scale-110 hover:brightness-110 hover:animate-pulse active:animate-bounce"
